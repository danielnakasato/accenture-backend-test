...
**Obs**: As chaves públicas e privadas estão no readme porque o dotenv tem um problema na hora de fazer o parse das chaves e acaba considerando as indentações como parte da chave e isso causa alguns problemas.
---
